		...
		options: [
			{
				...
				routing: { request: { method: 'POST', url: '/leavemutation' } },
			},
			{
				name: 'Get',
				value: 'get',
			...
			},
			{
				...
				routing: { request: { method: 'GET', url: '/leavemutation' } },
			},
		],
		default: 'getAll',
	},
		...
		options: [
			{
				...
				routing: { request: { method: 'POST', url: '/leaverequest' } },
			},
			{
				name: 'Get',
				value: 'get',
			...
			},
			{
				...
				routing: { request: { method: 'GET', url: '/leaverequest' } },
			},
			{
				name: 'Update',
				value: 'update',
